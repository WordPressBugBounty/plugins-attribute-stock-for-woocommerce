...
- Fixed a bug causing term multipliers to not work in some cases.

= 2.2.4 (2025-09-15) =
- Fixed match rules being removed during plugin upgrade in some case.
- Fixed PHP warnings in some cases.
